...
con_fannie <- connection_open(drv = SQLite(), dbname = 
                                  "/home/dnn/Data_science/Git/Business science/Database-SQL/lab_22_sql_advanced - llpro/lab_22_sql_advanced - llpro/fannie_mae_loans.sqlite")

#dbListTables(con_fannie)
