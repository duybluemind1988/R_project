...
Let's improve the graph with title and labels for the axis:
...
```{r graph 5, message=FALSE, warning=FALSE}
...
churn$Churn. <- NULL
set.seed(12)
trainIndex <- caret::createDataPartition(churn$Churned, p = .70, list = FALSE, times = 1)
...
prop.table(table(churnTrain$Churned))
```
